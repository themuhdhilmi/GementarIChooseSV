    ...
    <Banner className="w-full my-1">
      <div className="flex w-full flex-col justify-between rounded-lg border border-gray-100 bg-white p-4 shadow-sm dark:border-gray-600 dark:bg-gray-700 md:flex-row ">
        <div className="mb-3 mr-4 flex flex-col items-start md:mb-0 md:flex-row md:items-center">
            <span className="self-center whitespace-nowrap text-lg font-semibold dark:text-white md:pr-6 flex flex-row"><div className='text-red-700'><MdOutlineError /></div>{props?.student?.matricNumber}</span>
        ...
        <div className="flex gap-1 flex-shrink-0 items-center">
          <button onClick={selectionHandlerTrue} className='btn  rounded-lg border-0  bg-blue-950 text-white' >Accept</button>
