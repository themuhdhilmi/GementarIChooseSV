...
const page = () => {
  return (
    <div className="flex text-black bg-white dark:bg-gray-800 min-h-screen dark:text-white">
 ...
 <div className="flex-grow text-black dark:text-white">
  ...
  <div className="flex items-center p-8 bg-white dark:bg-gray-700 shadow rounded-lg">
    ...
    <div>
      <span className="inline-block text-2xl font-bold text-gray-800 dark:text-white">9</span>
      <span className="inline-block text-xl text-gray-500 font-semibold dark:text-gray-300">(14%)</span>
      <span className="block text-gray-500 dark:text-gray-300">Progress Completion</span>
    </div>
  </div>
  ...
  <div className="flex items-center p-8 bg-white dark:bg-gray-700 shadow rounded-lg">
    ...
    <div>
      <span className="block text-xl font-bold text-gray-800 dark:text-white">SESI 2 2023/2024</span>
      <span className="block text-gray-500 dark:text-gray-300">Session</span>
    </div>
  </div>
  ...
  <div className="flex items-center p-8 bg-white dark:bg-gray-700 shadow rounded-lg">
    ...
    <div>
      <span className="block text-xl font-bold text-gray-800 dark:text-white">Software and Application Development</span>
      <span className="block text-gray-500 dark:text-gray-300">Track</span>
    </div>
  </div>
  ...
  <div className="flex items-center p-8 bg-white dark:bg-gray-700 shadow rounded-lg">
    ...
    <div>
      <span className="block text-2xl font-bold text-gray-800 dark:text-white">Puan/Sir Name</span>
      <span className="block text-gray-500 dark:text-gray-300">Supervisor</span>
    </div>
  </div>
</section>
<section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-1 xl:grid-flow-col gap-6">
  ...
  <div className="flex flex-col row-span-3 bg-white dark:bg-gray-700 shadow rounded-lg">
    <div className="px-6 py-5 font-semibold border-b border-gray-100 dark:border-gray-800">Project Titles</div>
  ...
  <div className="flex flex-col md:col-span-2 md:row-span-2 bg-white dark:bg-gray-700 shadow rounded-lg">
    <div className="px-6 py-5 font-semibold border-b border-gray-100 dark:border-gray-800">Downloadables(Poster, Abstract, Etc)</div>
