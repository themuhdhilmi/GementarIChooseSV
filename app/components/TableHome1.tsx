    ...
    <div className="overflow-x-auto">
      <Table>
        ...
        <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
          {props?.data?.questionOnProgress?.length === 0 ? <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">No data</Table.Cell> : ""}
          {props?.data?.questionOnProgress?.length === 0 ? <Table.Cell>No data</Table.Cell> : ""}
          {props?.data?.questionOnProgress?.length === 0 ? <Table.Cell>No data</Table.Cell> : ""}
          </Table.Row>
