      ...
      {!isDesktop ? (
        <div className="flex flex-row gap-3 py-5">
          ...
          <div className="w-full flex flex-row-reverse">
            <Link
              href={``}
              className={`btn btn-sm rounded-lg border-0 text-red-600 bg-white hover: hover:text-white`}
            >
              <IoIosConstruct />
        ...
        <div>
          ...
          <div className="flex flex-wrap py-5 w-full">
            <Link
              ...
              } btn rounded-lg border-0 border-red-700 bg-red-700 text-white hover:bg-red-900 ${
                getFirstThreePathName() === "" ? "" : "bg-opacity-0"
              } hover:border-red-700 w-full`}
            >
              {isMobileLandscape ? (
                ""
              ) : (
          ...
          <div className="w-full flex">
            <Link
              ...
              className={`${
                isMobileLandscape ? "text-xs" : ""
              } btn rounded-lg border-0 text-red-600 bg-white hover: hover:text-white w-full my-5`}
            >
