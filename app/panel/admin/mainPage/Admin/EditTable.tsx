...
const EditTable = (props: any) => {
  ...
  return (
    <div className="  bg-white bg-opacity-70 shadow-lg rounded-lg p-5 m-5">
      <div className="flex ">
        <div className="flex-auto w-fit ">Edit Details</div>
        <div className="tooltip" data-tip="cancel">
          <button
            onClick={() => props.setCurrentPage(AdminTableList.MainTable)}
                  ...
                  <div className="">
                    <article>
                      <div className="font-bold break-all">
                        <p>{props.adminData.admin[props.editUserIndex].name}</p>
                      </div>
                      <div className="text-sm opacity-50 break-all">
                        <p>
                          {props.adminData.admin[props.editUserIndex].email}
                        </p>
                      </div>
                    </article>
                  </div>
