...
export function ConfirmScoreModal(props: any) {
  ...
  return (
    <>
      <Button onClick={() => setOpenModal(true)}>Confirm Score</Button>
      <Modal show={openModal} onClose={() => setOpenModal(false)}>
        <Modal.Header>Confirm Score</Modal.Header>
        ...
        <Modal.Footer>
          ...
          {getCantSubmit > 0 ? (
            <Alert color="failure" icon={HiInformationCircle}>
              <span className="font-medium">Warning!</span> To submit, please complete score for essay question.
            </Alert>
          ) : (
            false
          )}
