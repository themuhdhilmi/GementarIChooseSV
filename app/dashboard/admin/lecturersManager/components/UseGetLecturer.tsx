...
const UseGetLecturer = (props: any) => {
          ...
          >
            <div className={`${!isDesktop ? "w-1/4 " : "w-full "} px-1`}>
              <div className="flex flex-row bg-red-600 rounded-lg shadow-lg">
                ...
                <div className="my-3 w-full ">
                  ...
                  <p className="text-sm text-slate-100">
                    {props.selectViewUser?.lecturerInformation?.matricNumber}
                  </p>
                  <p className="text-sm text-slate-100">
              ...
              <div className="font-extrabold text-red-600 my-2  py-2 text-center rounded-lg shadow-2xl">
                {props.selectViewUser?.lecturerInformation?.Track}
              </div>
              ...
              <div className="text-center mt-2 font-extrabold">
                ...
                <p className="text-red-600">
                  {props.selectViewUser?.lecturerInformation?.memberQuota ??
                    "USING GLOBAL"}
                </p>
              </div>
              ...
              <div className="text-center mt-2 font-extrabold">
                <p>Title Quota</p>
                <p className="text-red-600">
                  {props.selectViewUser?.lecturerInformation?.titleQuota ??
                    "USING GLOBAL"}
                </p>
              </div>
            ...
            <div className={`${!isDesktop ? "w-3/4 " : "w-full "}  px-4 `}>
              <div className="overflow-x-auto px-5 rounded-lg shadow-lg">
                ...
                {props.selectViewUser?.lecturerInformation?.Member?.length ===
                0 ? (
                  <div className="py-6">
                    <HereIsEmpty />
                  </div>
                  ...
                  <table className="table ">
                    <tbody>
                      {props.selectViewUser?.lecturerInformation?.Member.map(
